...
public class DefaultExperimentGenerator {
	...
	static File trainingDataFile = new File("output/classification/trainingData.txt");

	static File resultsOutputFile = new File("output/classification/defaultResults/preClassified");
