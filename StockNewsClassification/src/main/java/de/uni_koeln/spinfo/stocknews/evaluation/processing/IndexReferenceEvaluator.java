...
public class IndexReferenceEvaluator extends AbstractStockEvaluator {

	
//	static DateTimeFormatter formatter = DateTimeFormatter.ofPattern("EEEE");
	
	public IndexReferenceEvaluator(CompanyStockTables cst){
		super(cst);
	}
	
	public IndexReferenceEvaluator() {
		super();
	}
