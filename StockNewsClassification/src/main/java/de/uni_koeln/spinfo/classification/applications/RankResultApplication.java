...
public class RankResultApplication {
	...
	static String toRank = "output/classification/defaultResults/preClassified";
	static String output = "output/classification/rankings/defaultResults/preClassified";
